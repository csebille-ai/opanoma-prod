        ...
        try {
          if (window.PopupAdapter && window.PopupAdapter._lastThemeMsgBox) {
            ...
            function makePanel(titleText, explText, count) {
              ...
              Object.assign(h.style, { margin: '0 0 8px 0', fontSize: '16px' });
              const para = document.createElement('div'); para.innerHTML = String(explText);
              Object.assign(para.style, { fontSize: '13px', marginBottom: '10px', color: 'rgba(255,255,255,0.9)', flex: '1 1 auto' });
              const btn = document.createElement('button'); btn.textContent = 'Choisir ' + count + ' cartes';
              Object.assign(btn.style, { padding: '8px 12px', borderRadius: '8px', cursor: 'pointer', border: 'none', background: '#e75480', color: '#fff' });
            ...
            Object.assign(p3h.style, { margin: '0 0 8px 0', fontSize: '16px' });
            ...
            Object.assign(p3para.style, { fontSize: '13px', marginBottom: '10px', color: 'rgba(255,255,255,0.95)', flex: '1 1 auto' });
            const p3btn = document.createElement('button'); p3btn.textContent = 'Choisir 3 cartes';
            Object.assign(p3btn.style, { padding: '8px 12px', borderRadius: '8px', cursor: 'pointer', border: 'none', background: '#e75480', color: '#fff' });
            ...
            Object.assign(p5h.style, { margin: '0 0 8px 0', fontSize: '16px' });
            ...
            Object.assign(p5para.style, { fontSize: '13px', marginBottom: '10px', color: 'rgba(255,255,255,0.95)', flex: '1 1 auto' });
            const p5btn = document.createElement('button'); p5btn.textContent = 'Choisir 5 cartes';
            Object.assign(p5btn.style, { padding: '8px 12px', borderRadius: '8px', cursor: 'pointer', border: 'none', background: '#e75480', color: '#fff' });
